...
LAYER 3: MCP Server + LLM Orchestration
 - 101 MCP tools expose pipeline state, rules evaluation, setup lifecycle state, research queries, and data queries
...
| MCP server | `rmcp` crate | 101 MCP tools via stdio transport |
