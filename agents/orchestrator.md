...
| Trader annotates Positioning (Slice or Levels-Only Record), including mid-day flip/wall/BALANCE→TEST re-reads | `positioning_entry` for the durable Levels-Only Record; `save_agent_insight` for teaching co-annotation | `positioning_annotation` |
