...
mod tests {
    ...
    fn base_state() -> MarketState {
        MarketState {
            ...
            has_recent_invalidated_absorption: false,
            recent_invalidated_absorption_price: None,
            recent_invalidated_absorption_direction: None,
            recent_invalidated_absorption_age_ms: None,
            recent_invalidated_absorption_distance_ticks: None,
            ...
            sessions_in_trend: 0,
            active_zone_count: 0,
            rebid_zone_near: false,
            reoffer_zone_near: false,
            rebid_zone_retested: false,
            reoffer_zone_retested: false,
            rebid_zone_held: false,
            reoffer_zone_held: false,
            nearest_zone_direction: None,
            nearest_zone_status: None,
            nearest_zone_distance_ticks: None,
            rebid_zone_low: None,
            rebid_zone_high: None,
            reoffer_zone_low: None,
            reoffer_zone_high: None,
            poor_high: false,
            poor_low: false,
            excess_high: false,
            excess_low: false,
