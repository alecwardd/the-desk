...
impl TheDeskMcp {
    ...
    pub(crate) async fn feature_registry(
        ...
        Ok(text_result(serde_json::json!({
            ...
            "note": "Your playbook / your rules say how to use a registered descriptor. Discovery rides search_catalog when [sil].catalog_discovery is true; this verb does not change Base Detector math, does not run codegen emitters, and does not place orders."
        })))
    }
}
