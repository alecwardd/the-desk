...
| **Feature-IR** | Typed intermediate representation for Derived Features. Not Turing-complete; live-shadow and historical evaluation share one evaluator over Journal Frames. Codegen emitters are a later milestone. |
